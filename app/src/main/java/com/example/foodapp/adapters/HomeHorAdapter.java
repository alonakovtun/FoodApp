            ...
            holder.cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0){
                        ...
                        ArrayList<HomeVerModel> homeVerModels = new ArrayList<>();
                        homeVerModels.add(new HomeVerModel(R.drawable.ice_cream1, "Ice Cream 1", "10:00 - 23:00", "4.9", "Min - $35"));
                        homeVerModels.add(new HomeVerModel(R.drawable.ice_cream2, "Ice Cream 2", "10:00 - 23:00", "4.9", "Min - $35"));
